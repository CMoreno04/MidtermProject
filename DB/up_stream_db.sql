...
START TRANSACTION;
USE `Up_Stream`;
INSERT INTO `user_image` (`id`, `url`) VALUES (1, 'https://i.pinimg.com/originals/6a/a0/1d/6aa01d8d0ff762c76f3d298d7f8fa6a9.png');
INSERT INTO `user_image` (`id`, `url`) VALUES (2, 'https://res.cloudinary.com/teepublic/image/private/s--anfOoZiC--/t_Preview/b_rgb:908d91,c_limit,f_jpg,h_630,q_90,w_630/v1527361512/production/designs/2725870_0.jpg');
...
INSERT INTO `user_image` (`id`, `url`) VALUES (4, 'https://vignette.wikia.nocookie.net/dcanimated/images/3/39/SupermanJLU.png/revision/latest?cb=20130305134005');
INSERT INTO `user_image` (`id`, `url`) VALUES (5, 'https://images-na.ssl-images-amazon.com/images/I/51BpHfyGN2L.jpg');
INSERT INTO `user_image` (`id`, `url`) VALUES (6, 'https://library.kissclipart.com/20180830/hpe/kissclipart-elmo-png-clipart-elmo-cookie-monster-clip-art-f71f2d7ed96a5f05.jpg');
...
INSERT INTO `user_image` (`id`, `url`) VALUES (8, 'https://cdn.vox-cdn.com/thumbor/8FZtvc_neQAUFIniFQ5Ru2xfQlM=/0x0:1024x429/1200x800/filters:focal(510x140:672x302)/cdn.vox-cdn.com/uploads/chorus_image/image/58012209/Star_Wars_Porg_Gift_Ideas.0.jpg');
