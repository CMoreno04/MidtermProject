...
<body>
	...
	<div class="container text-center align-middle"
		style="margin-top: 20px; border-radius: 10px; padding: 10px; box-shadow: 0 5px 15px 5px rgba(153, 153, 153, 0.35)">
		<%--         <table>
	        <tr class="row d-flex">
			...
			<div class="col">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<img src="${user.userImage.url}" width="150px" height="150px" style="border-radius: 50%;  border: 0.5rem solid #00bc8c;">
				...
				<c:forEach items="${userService}" var="service" varStatus="loop">
					<td class="col-4">
						...
						<div class="container-fluid">
							<div class="card text-white mb-3 text-center d-flex"
								style="background-color: rgba(32, 201, 151, 0.2);">
	...
	<div class="container" style="margin-top: 50px">
		...
		<table class="table">
			<c:forEach items="${reviews}" var="rev" varStatus="loop">
				<tr class="d-flex">
					<td class="col-sm-4"><a
						href="getContents.do?id=${rev.content.id}">${rev.content.title}</a>
					</td>
					<td class="col-sm-4"><c:choose>
									...
									<div class="modal-dialog modal-dialog-scrollable"
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<form action="updateReviewFromProf.do" method="POST"
													modelAttribute="review" style="margin-right: 10px">
													Rating:<br> <select name="rating"
														selected="${rev.rating}"
														style="background-color: rgba(255, 255, 255, 0.4); color: black;">
													...
													</select><br> Comment:<br>
													<textarea class="form-control" name="comment"
														style="background-color: rgba(255, 255, 255, 0.4); color: black;">${rev.comment}</textarea>
													<input type="hidden" name="userId" value="${user.id}">
													<input type="hidden" name="contentId"
														value="${rev.content.id}"> <input type="hidden"
														name="updateById" value="${rev.id}"> <br> <input
	...
	<c:if test="${user.admin == true}">
		<div class="container text-center"
			...
			<h4 style="margin-bottom: 10px; margin-top: 10px;">Admin Center</h4>
